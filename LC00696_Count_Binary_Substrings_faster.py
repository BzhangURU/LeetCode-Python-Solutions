# LC00696_Count_Binary_Substrings_faster.py
...
# Idea: count consecutive numbers: 000011100: 4,3,2, then the answer is min(4,3)+min(3,2)
...
class Solution:
    def countBinarySubstrings(self, s: str) -> int:
        ...
        for i in range(1,len(s)):
            if s[i-1]!=s[i]:
                result+=min(last_count,cur_count)
