# LC00806_Number_of_Lines_To_Write_String.py
...
# you stopped in s, continue writing as many letters as you can on the second line. Continue this process until you 
...
class Solution:
    def numberOfLines(self, widths: List[int], s: str) -> List[int]:
        ...
        for i in range(len(s)):
            cur_char_width=widths[ord(s[i])-ord('a')]
            if cur_width+cur_char_width<=100:
                cur_width+=cur_char_width
            else:
                cur_line_ind+=1
                cur_width=cur_char_width
        return [cur_line_ind+1,cur_width]
