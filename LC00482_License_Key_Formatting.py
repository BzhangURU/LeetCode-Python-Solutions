# LC00482_License_Key_Formatting.py

# You are given a license key represented as a string s that consists of only alphanumeric 
# characters and dashes. The string is separated into n + 1 groups by n dashes. You are also given an integer k.
